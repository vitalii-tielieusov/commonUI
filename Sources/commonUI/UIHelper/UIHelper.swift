...
public final class UIHelper {
    ...
    public class func prepareScrollView(disableContentInsetAdjustmentBehavior: Bool = true) -> UIScrollView {
    ...
    public class func createTableView<T: UITableViewCell>(
    ...
    public class func prepareCollectionView<T: UICollectionViewCell>(
    ...
    class private func prepareCollectionViewFlowLayout(
        scrollDirection: UICollectionView.ScrollDirection,
...
public final class LayoutsHelper {
    ...
    public class func scaleByScreenWidth(constraintValue: CGFloat) -> CGFloat {
        return (constraintValue * UIScreen.main.bounds.size.width) / ScreenSizeByDesign.width
    }
    
    public class func scaleByScreenHeight(constraintValue: CGFloat) -> CGFloat {
